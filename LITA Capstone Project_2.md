...
This project analyzes customer data from a subscription service to identify behavior patterns, track subscription types, and uncover trends in cancellations and renewals. The report is presented through a Power BI dashboard, segmented into three main pages for clear insight.
...
Total Transactions Card: Displays the total number of transactions recorded (e.g., 75,000).Customer Count Card: Shows the number of unique customers contributing to these transactions.
...
Objective: Highlight subscription patterns and revenue, giving a detailed view of types and status.Visualizations:

Subscription Type Pie Chart: Displays the distribution of all subscription types by customer count (Basic, Premium, Standard, etc.).
Subscription Status Pie Chart: Shows the proportion of active and canceled subscriptions.
Revenue & Average Duration Cards:
Revenue: Total revenue generated from all subscriptions.
Average Subscription Duration: Average duration of subscriptions across all customers.Transaction Count: The total number of transactions recorded.
...
Key Metrics Cards:
Number of Regions: Total number of regions represented.Customer Count: Number of customers across all regions.
Revenue Generated: Total revenue attributed to each region.
